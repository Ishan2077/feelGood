...
class LoginScreenSuccess(Screen):
    ...
    def get_quote(self, feel):
        ...
        if feel in available_feelings:
            ...
            self.ids.quote.text = "Whoops! Can not generate any quote. Please type something..."
            

class RootWidget(ScreenManager):
    pass

class ImageButton(ButtonBehavior, HoverBehavior, Image):  #holds behavior of all three items
    pass
